...
ace.settings = {
    ...
    sidebar_fixed: function (sidebar, fix, save, chain) {
        ...
        if (window.jQuery)
            jQuery(document).trigger('settings.ace', ['sidebar_fixed', fix, sidebar]);
    },
    //fixed position
    breadcrumbs_fixed: function (breadcrumbs, fix, save, chain) {
        ...
        if (window.jQuery)
            jQuery(document).trigger('settings.ace', ['breadcrumbs_fixed', fix, breadcrumbs]);
    },
    //fixed size
    main_container_fixed: function (main_container, inside, save) {
        ...
        if (inside) {
            ...
            if (navbar_container && !ace.hasClass(navbar_container, 'container'))
        ...
        if (window.jQuery)
            jQuery(document).trigger('settings.ace', ['main_container_fixed', inside, main_container]);
    },
    sidebar_collapsed: function (sidebar, collapse, save) {
        ...
        if (window.jQuery)
            jQuery(document).trigger('settings.ace', ['sidebar_collapsed', collapse, sidebar]);
