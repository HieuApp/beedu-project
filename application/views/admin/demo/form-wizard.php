                            ...
                            <div class="step-content pos-rel">
                                <div class="step-pane active" data-step="1">
                                    ...
                                    <form class="form-horizontal" id="sample-form">
                                        ...
                                        <div class="form-group has-warning">
                                            <label for="inputWarning"
                                                   class="col-xs-12 col-sm-3 control-label no-padding-right">Input with
                                                warning</label>
                                            ...
                                            <div class="help-block col-xs-12 col-sm-reset inline"> Warning tip help!
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <div class="help-block col-xs-12 col-sm-reset inline"> Success tip help!
                                            </div>
                                        </div>
                                    ...
                                    <form class="form-horizontal hide" id="validation-form" method="get">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">Company
                                                Name:</label>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="url">Company
                                                URL:</label>
