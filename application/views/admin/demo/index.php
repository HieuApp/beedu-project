                                            ...
                                            <div class="itemdiv memberdiv">
                                                <div class="user">
                                                    <img alt="Bob Doe's avatar"
                                                         src="<?php echo base_url("upload/demo/avatars/user.jpg") ?>"/>
                                                </div>
                                            ...
                                            <div class="itemdiv memberdiv">
                                                <div class="user">
                                                    <img alt="Joe Doe's avatar"
                                                         src="<?php echo base_url("upload/demo/avatars/avatar2.png") ?>"/>
                                                </div>
                                            ...
                                            <div class="itemdiv memberdiv">
                                                <div class="user">
                                                    <img alt="Jim Doe's avatar"
                                                         src="<?php echo base_url("upload/demo/avatars/avatar.png") ?>"/>
                                                </div>
                                            ...
                                            <div class="itemdiv memberdiv">
                                                <div class="user">
                                                    <img alt="Alex Doe's avatar"
                                                         src="<?php echo base_url("upload/demo/avatars/avatar5.png") ?>"/>
                                                </div>
                                            ...
                                            <div class="itemdiv memberdiv">
                                                <div class="user">
                                                    <img alt="Susan's avatar"
                                                         src="<?php echo base_url("upload/demo/avatars/avatar3.png") ?>"/>
                                                </div>
                                            ...
                                            <div class="itemdiv memberdiv">
                                                <div class="user">
                                                    <img alt="Phil Doe's avatar"
                                                         src="<?php echo base_url("upload/demo/avatars/avatar4.png") ?>"/>
                                                </div>
                                            ...
                                            <div class="itemdiv memberdiv">
                                                <div class="user">
                                                    <img alt="Alexa Doe's avatar"
                                                         src="<?php echo base_url("upload/demo/avatars/avatar1.png") ?>"/>
                                                </div>
