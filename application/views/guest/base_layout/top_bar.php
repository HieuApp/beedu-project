<nav class="black" role="navigation">
    <div class="nav-wrapper container">
        ...
        <ul class="right hide-on-med-and-down">
            <li><a href="#edu_method" id="edu-method"><?php echo $menu_1; ?></a></li>
            <li><a href="#edu_program" id="edu-program"><?php echo $menu_2; ?></a></li>
            <li><a href="#edu_library" id="edu-library"><?php echo $menu_3; ?></a></li>
            <li><a href="#answer_question" id="answer-question"><?php echo $menu_4; ?></a></li>
            <li><a href="#intro_beedu" id="intro-beedu"><?php echo $menu_5; ?></a></li>
        </ul>
